(() => {
  ...
  if (background && !background.querySelector('.automation-note')) {
    ...
    if (credentials) {
      ...
      detail.className = 'background-link';
      detail.href = 'work.html';
      detail.textContent = 'See research, projects and engineering work ↗';
      credentials.insertAdjacentElement('afterend', detail);
    }
  }
  ...
  if (socials && !socials.querySelector('a[href="https://www.fiverr.com/techmafia101"]')) {
    ...
    detailed.href = 'work.html';
    detailed.textContent = 'Detailed work ↗';
    socials.appendChild(detailed);
  }
})();
